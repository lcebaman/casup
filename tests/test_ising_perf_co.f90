!*robodoc*u* tests/test_ising_perf_co
!  NAME
!    test_ising_perf_co
!  SYNOPSIS

!$Id: test_ising_perf_co.f90 536 2018-04-03 12:02:13Z mexas $

program test_ising_perf_co

!  PURPOSE
!    Test performance of Ising magnetisation.
!    This test uses coarrays for the whole model, not just halos!
...
do run=1,3
  select case(run)
   ...
   ! subroutine ca_co_ising_energy( space, hx_sub, iter_sub, kernel,   &
   !  energy, magnet )
...
end program test_ising_perf_co
