...
!  DESCRIPTION
!    Checking probabilistic cleavage propagation with 1 cleavage
!    nucleus in the middle of image 1.  Single grain with random
!    orientation.  Multiple cleavage increments. Halo exchange,
!    so cleavage propagation across image boundary.
