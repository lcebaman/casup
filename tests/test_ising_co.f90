!*robodoc*u* tests/test_ising_co
!  NAME
!    test_ising_co
!  SYNOPSIS

!$Id: test_ising_co.f90 538 2018-04-03 14:01:29Z mexas $

program test_ising_co

!  PURPOSE
!    Test Ising magnetisation + timing.
!    Use whole model coarrays, not just coarray halos.
!  DESCRIPTION
