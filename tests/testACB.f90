...
!  PURPOSE
!    Testing cgca_m2gl/cgca_ico2.
!  DESCRIPTION
!    cgca_ico2 converts some image index into its cosubscripts.
!    Lots of data has to be set prior to calling cgca_ico2.
!    The test can be run on any number of images.
!    space coarray is established and the cgca_ico2 is called
