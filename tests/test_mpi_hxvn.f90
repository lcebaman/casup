!*robodoc*u* tests/test_mpi_hxvn
!  NAME
!    test_mpi_hxvn
!  SYNOPSIS

!$Id: test_mpi_hxvn.f90 537 2018-04-03 13:57:55Z mexas $

program test_hxvn_mpi

!  PURPOSE
!    Test MPI HX routines: ca_mpi_halo_type_create, ca_mpi_hx_all,
!    ca_mpi_halo_type_free. The kernel is a simply copy.
!  DESCRIPTION
!    Even though halo coarrays are not needed in MPI HX, they are used
!    because they provide a logical 3D arrangement of images/MPI ranks.
